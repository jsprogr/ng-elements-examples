...
@Component({
  templateUrl: "./chart-filter-example.component.html",
  styleUrls: ["./chart-filter-example.component.scss"],
})
export class ChartFilterExampleComponent implements OnInit {
  title = "chart-filter";
